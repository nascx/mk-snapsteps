  ...
  "src/controllers/sgiCtrl.ts"() {
    ...
    handleUploadIT = exports.handleUploadIT = async (req, res) => {
      try {
        ...
        const it = await _chunkC5GCJCLCjs.existsThisIT.call(void 0, filePath);
        if (!it.status) {
          await _chunkC5GCJCLCjs.insertIT.call(void 0, filePath, name);
        } else {
...
//# sourceMappingURL=chunk-DXXSPAZG.js.map