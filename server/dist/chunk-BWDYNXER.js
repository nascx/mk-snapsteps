  ...
  "src/controllers/producionCtrl.ts"() {
    ...
    downloadList = exports.downloadList = async (req, res) => {
      try {
        ...
        const productionList = await _chunk7D2CMYFXjs.getContentFromProductionList.call(void 0, model, product, line);
        if (productionList.status) {
          ...
          const engineeringList = await _chunk7D2CMYFXjs.getContentFromEngineeringList.call(void 0, model, product);
    ...
    getModelAndProductOptions = exports.getModelAndProductOptions = async (req, res) => {
      try {
        const options = await _chunk7D2CMYFXjs.searchByModelAndProductOptions.call(void 0, );
    ...
    getModelProductOptionsAndLine = exports.getModelProductOptionsAndLine = async (req, res) => {
      try {
        const options = await _chunk7D2CMYFXjs.searchByModelAndProductOptionsAndLine.call(void 0, );
        res.status(200).json(options);
      } catch (error) {
        res.status(500).json(error);
      }
    ...
    uploadProductionLists = exports.uploadProductionLists = async (req, res) => {
      try {
        ...
        const existThisListProd = await _chunk7D2CMYFXjs.exsitsThisListInProductionLists.call(void 0, model, product, line);
        if (existThisListProd.status) {
          console.log("J\xE1 exite lista com esse modelo e produto e linha");
          await _chunk7D2CMYFXjs.updateListInProductionLists.call(void 0, model, product, line, content);
        } else {
          console.log("Ainda n\xE3o existe lista com esse modelo produto e linha");
          await _chunk7D2CMYFXjs.saveNewListInProductionLists.call(void 0, model, product, line, content);
        }
    ...
    sendIT = exports.sendIT = async (req, res) => {
      try {
        const { model, product, line } = req.query;
        const prodList = await _chunk7D2CMYFXjs.exsitsThisListInProductionLists.call(void 0, model, product, line);
        if (prodList.status) {
...
//# sourceMappingURL=chunk-BWDYNXER.js.map